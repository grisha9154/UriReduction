...
var FileUpload = (_dec = (0, _reactRedux.connect)(null, actions), _dec(_class = (0, _radium2.default)(_class = (_class2 = (_temp2 = _class3 = function (_Component) {
    ...
    (0, _createClass3.default)(FileUpload, [{
                    ...
                    return _regenerator2.default.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    _props = this.props, addUploadingDocs = _props.addUploadingDocs, addUploadingImages = _props.addUploadingImages, allowedFileTypes = _props.allowedFileTypes, data = _props.data, dropzoneId = _props.dropzoneId, identifier = _props.identifier, uploadFiles = _props.uploadFiles, url = _props.url;
            ...
            value: function render() {
                var _props2 = this.props, children = _props2.children, className = _props2.className, dropzoneActiveStyle = _props2.dropzoneActiveStyle, dropzoneId = _props2.dropzoneId, dropzoneStyle = _props2.dropzoneStyle, multiple = _props2.multiple;
                var dropzoneActive = this.state.dropzoneActive;
                return _react2.default.createElement('div', { className: className }, _react2.default.createElement('form', { ref: 'fileUpload' }, _react2.default.createElement('label', { style: [dropzoneStyle || styles.dropzone.base, dropzoneActive && (dropzoneActiveStyle || styles.dropzone.active)] }, _react2.default.createElement('input', {
                    id: dropzoneId,
                    multiple: multiple,
                    ref: 'fileInput',
                    style: styles.input,
    ...
    addUploadingDocs: _propTypes2.default.func.isRequired,
    addUploadingImages: _propTypes2.default.func.isRequired,
    uploadFiles: _propTypes2.default.func.isRequired,
    dropzoneActiveStyle: _propTypes2.default.object,
    dropzoneId: _propTypes2.default.string.isRequired,
    dropzoneStyle: _propTypes2.default.object,
...
//# sourceMappingURL=FileUpload.react.js.map